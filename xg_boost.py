...
# XGBoost Only - Step by Step Learning Program
# ============================================================
...
print("\nMeaning:")
print("Training data is used to teach the XGBoost model")
...
# ------------------------------------------------------------
# Step 9: Calculate Class Imbalance Weight
# ------------------------------------------------------------

print("\nSTEP 9: Calculating churn class weight...")

stay_count = y_train.value_counts()[0]
churn_count = y_train.value_counts()[1]

scale_pos_weight = stay_count / churn_count

print("Stay customers in training data :", stay_count)
print("Churn customers in training data:", churn_count)
print("scale_pos_weight:", round(scale_pos_weight, 2))

print("\nMeaning:")
print("XGBoost uses scale_pos_weight to give more importance to churn customers")
print("This helps when churn customers are less compared to stay customers")
...
print("\nMeaning:")
print("XGBoost builds trees one by one")
print("Each new tree tries to correct the mistakes of previous trees")
print("This is called boosting")

wait_for_user()


# ------------------------------------------------------------
# Step 11: Predict Using Probability Threshold
# ------------------------------------------------------------

print("\nSTEP 11: Predicting using XGBoost with custom threshold...")

xgb_probabilities = xgb_model.predict_proba(X_test)

# Probability of churn class 1
churn_probabilities = xgb_probabilities[:, 1]

# Default threshold is 0.50
# Lower threshold catches more churn customers
threshold = 0.35

xgb_pred = (churn_probabilities >= threshold).astype(int)
...
print("\nSTEP 12: Evaluating XGBoost model...")
...
print("Accuracy alone is not enough for churn prediction")
...
print("\nSTEP 13: Finding important churn factors...")
...
print("XGBoost uses these features while building multiple boosted trees")
...
print("\nSTEP 14: Comparing different threshold values...")
...
# ------------------------------------------------------------
# Step 15: Predict One Sample Customer
# ------------------------------------------------------------

print("\nSTEP 15: Predicting one sample customer...")
...
sample_probability = xgb_model.predict_proba(sample_customer)[0]
...
print("""
This XGBoost program completed the following:
...
7. Calculated class imbalance weight
8. Trained XGBoost model
